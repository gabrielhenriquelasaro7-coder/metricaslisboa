...
export function DiagnosticResults({ project, onBack, onEdit, onSave }: ResultsProps) {
    ...
    return (
        <div className="dark space-y-8 animate-in fade-in zoom-in-95 duration-700 bg-zinc-950 rounded-[2rem] p-3 sm:p-5 lg:p-6 border border-white/5 overflow-hidden relative shadow-2xl w-full">
